...
public class InfoSubGrupos_Fragment extends Fragment {
    ...
    public void AñadirParticipantes(){
        Intent intent = new Intent(getContext(), SubGroupAddParticipant.class);
    ...
    private void MostrarParticipantesGpo(){
        ...
        ref.child(group_id).child("SubGroups").child(sub_group_Id).child("Participantes").addValueEventListener(new ValueEventListener() {
            @Override
