...
public class ChatSubGroup_Fragment extends Fragment {
    ...
    //ID DEL USUARIO LOGEADO , ID DEL GRUPO Y DEL SUBGRUPO
    ...
    String mUri;
    private StorageReference Sreference = FirebaseStorage.getInstance().getReference("SubGroupChatImages");
    private StorageReference Freference = FirebaseStorage.getInstance().getReference("SubGroupChatFiles");
    Uri imagenUri;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        subgroupid = prefs.getString("SubgroupId", "");
        ...
        btn_send.setOnClickListener(new View.OnClickListener(){
            ...
            public  void onClick(View view){
                ...
                if(!msg.equals("")){
                 ...
                 sendMesage(fuser.getUid(), groupid,subgroupid,msg);
        ...
        readMessages(subgroupid);
        return  view;

    }


    private void sendMesage(String sender, String groupId,  String subgroupid,String message){
        ...
        ref.child(groupId).child("SubGroups").child(subgroupid).child("Chats").child(id).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
    ...
    private void readMessages (String subgroupid){
        mchat = new ArrayList<>();


        reference = FirebaseDatabase.getInstance().getReference("Groups").child(groupid).child("SubGroups").child(subgroupid).child("Chats");
    ...
    private void sendImageMessage(String sender, String groupId,  String subgroupid,Uri imagenUri){
        //ID del mensaje
        String id= ""+System.currentTimeMillis();
            ...
            uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()){
                        ...
                        reference.child(groupId).child("SubGroups").child(subgroupid).child("Chats").child(id).setValue(hashMap);
    ...
    private  void uploadPDFtoFirebase(String sender, String groupId,  String subgroupid,Uri data){
        //ID del mensaje
        String id= ""+System.currentTimeMillis();
        this.pd = ProgressDialog.show(getContext(), "Jobi",
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == IMAGE_REQUEST && resultCode == Activity.RESULT_OK
            ...
            sendImageMessage(fuser.getUid(), groupid,subgroupid,imagenUri);
        ...
        if(requestCode == 12 && resultCode == Activity.RESULT_OK
                && data != null && data.getData() != null){
            uploadPDFtoFirebase(fuser.getUid(),groupid,subgroupid,data.getData());
        }
    ...
    private void CompartirUbicaion(String sender, String groupId ){
        //ID del mensaje
        String id= ""+System.currentTimeMillis();
