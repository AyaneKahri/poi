...
public class AddParticipantsAdapter extends RecyclerView.Adapter<AddParticipantsAdapter.ViewHolder> {
    ...
    public AddParticipantsAdapter(Context mContext, List <User> mUsers, String group_id, String role ){
    ...
    public AddParticipantsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AddParticipantsAdapter.ViewHolder(view);
    }
    @Override
    ...
    DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Groups");
    ref.child(group_id).child("Participantes").child(user.getId()).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
    @Override
